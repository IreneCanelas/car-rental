...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const cars: Car[] = [
      { id: '1', manufacturer: 'Toyota', model: 'Camry', license_plate: 'ABC123', year: 2021, rate_per_day: 50.60, status: CarStatus.AVAILABLE },
      { id: '2', manufacturer: 'Honda', model: 'Accord', license_plate: 'XYZ789', year: 2020, rate_per_day: 45, status: CarStatus.UNAVAILABLE },
      { id: '3', manufacturer: 'Ford', model: 'Mustang', license_plate: 'FOR123', year: 2019, rate_per_day: 65.30, status: CarStatus.AVAILABLE },
      ...
      { id: '8', manufacturer: 'Nissan', model: 'Altima', license_plate: 'NIS456', year: 2022, rate_per_day: 38.90, status: CarStatus.UNAVAILABLE },
      { id: '9', manufacturer: 'Hyundai', model: 'Elantra', license_plate: 'HYU789', year: 2021, rate_per_day: 33, status: CarStatus.AVAILABLE },
      { id: '10', manufacturer: 'Kia', model: 'Sorento', license_plate: 'KIA012', year: 2020, rate_per_day: 37.99, status: CarStatus.AVAILABLE }
    ];
